    ...
    <div class="lwa lwa-default clearfix">
        <form class="lwa-form clearfix" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
            ...
            <div class="cb-form-body">
                <div class="cb-username"><i class="icon-user"></i><input type="text" name="log" placeholder="<?php esc_html_e( 'Username', 'cubell' ); ?>"></div>
                <div class="cb-password"><i class="icon-lock"></i><input type="password" name="pwd" placeholder="<?php esc_html_e( 'Password', 'cubell' ) ?>"></div>
        ...
        <form class="lwa-remember clearfix" action="<?php echo esc_attr(LoginWithAjax::$url_remember) ?>" method="post" style="display:none;">
            ...
            <div class="cb-form-body">
                <div class="cb-email"> 
                        ...
                        <i class="icon-envelope-alt"></i><input type="text" name="user_login" class="lwa-user-remember" placeholder="<?php esc_html_e( 'Enter username or email', 'cubell' ) ?>">
    		...
    		<div class="cb-join-modal lwa-register lwa-register-default <?php echo $cb_menu_color; ?>">
    		    <form class="lwa-register-form clearfix" action="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" method="post">
                    ...
                    <div class="cb-form-body">
                        ...
                        <div class="cb-username"><i class="icon-user"></i><input type="text" name="user_login" class="user_login input" placeholder="<?php esc_html_e( 'Username', 'cubell' ); ?>"></div>
                        <div class="cb-email"><i class="icon-envelope-alt"></i><input type="text" name="user_email" class="user_email input" placeholder="<?php esc_html_e( 'Email', 'cubell' ); ?>"></div>
