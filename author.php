...
<div class="cb-cat-header<?php if ($cb_theme_style == 'cb_boxed') echo ' wrap'; ?>">
		...
		<?php //echo __( 'Author', 'cubell' ) . ' <i class="icon-long-arrow-right"></i></span> '.$cb_author_name; ?>
		<?php //echo $cb_author_name; ?>
		<?php //echo __( 'Author', 'cubell' ) . ' <i class="icon-long-arrow-right"></i></span> ';?>
        <?php //echo show_author_name(); ?>
        </h1>
