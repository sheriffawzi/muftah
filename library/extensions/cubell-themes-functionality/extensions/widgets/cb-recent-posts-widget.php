...
if ( ! class_exists( 'CB_WP_Widget_Recent_Posts' ) ) {
    ...
    echo $before_widget; 
    		...
    		<ul class="cb-light <?php echo $type; ?>">
    		 ...
    		 ?>
                ...
                <li class="cb-article clearfix">
                    ...
                    <div class="cb-meta">    
                        ...
                        <?php if ($type == 'cb-big') { echo '<div class="cb-excerpt">'. cb_clean_excerpt(120).'</div>'; } ?>
                   </div> 
                </li>
    		<?php endwhile; ?>
    		</ul>
    ...
    ?>
            ...
            <?php foreach ($cb_cats as $cat) {
    		 ...
    		 <select id="<?php echo $this->get_field_id( 'type' ); ?>" name="<?php echo $this->get_field_name( 'type' ); ?>">
               <option value="cb-small" <?php if ($type == 'cb-small') echo 'selected="selected"'; ?>>Small</option> 
               <option value="cb-big" <?php if ($type == 'cb-big') echo 'selected="selected"'; ?>>Big</option> 
