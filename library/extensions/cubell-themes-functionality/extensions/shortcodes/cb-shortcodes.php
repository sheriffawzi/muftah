...
if ( ! function_exists( 'videogallery_shortcode' ) ) {
	function cb_videogallery_shortcode( $atts, $content = NULL ) {
		...
		if ( $size == 2 ) {
		  return '<div class="cb-video-gallery">'.do_shortcode('[column size=one_half position=first ]<a class="cb-lightbox" title="'.$caption1.'" href="' . $cb_url_1 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'.$image1.'" alt="video gallery"></a>[/column][column size=one_half position=last ]<a class="cb-lightbox" title="'.$caption2.'" href="'.$cb_url_2.'" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'.$image2.'" alt="video gallery"/></a>[/column]').'</div>'; 
		} elseif ( $size == 3 ) {

    					
    		 return '<div class="cb-video-gallery">'. do_shortcode('[column size=one_third position=first ]<a class="cb-lightbox" title="'.$caption1.'" href="' . $cb_url_1 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'. $image1 .'" alt="video gallery"></a>[/column][column size=one_third position=middle]<a class="cb-lightbox" title="'. $caption2 .'" href="'. $cb_url_2 .'" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'.$image2.'" alt="video gallery"></a>[/column][column size=one_third position=last ]<a class="cb-lightbox" title="'.$caption3.'" href="'.$cb_url_3.'" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'. $image3 .'" alt="video gallery"></a>[/column]') .'</div>'; 
		} elseif ( $size == 4 ) {
			   		
    		return '<div class="cb-video-gallery">'.do_shortcode('[column size=one_quarter position=first ]<a class="cb-lightbox" title="'.$caption1.'" href="' . $cb_url_1 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="' . $image1 . '" alt="video gallery"></a>[/column][column size=one_quarter position=middle ]<a class="cb-lightbox" title="' . $caption2 . '" href="' . $cb_url_2 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="'.$image2.'" alt=video gallery"></a>[/column][column size=one_quarter position=middle ]<a class="cb-lightbox" title="'.$caption3.'" href="' . $cb_url_3 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="' . $image3 . '" /></a>[/column][column size=one_quarter position=last ]<a class="cb-lightbox" title="' . $caption4 . '" href="' . $cb_url_4 . '" rel="video_gallery"><div class="cb-media-icon"><i class="icon-play"></i></div><img class="alignnone size-medium" src="' . $image4 . '" alt="video gallery"></a>[/column]').'</div>'; 
		} 
	}
...
if ( ! function_exists( 'cb_tab_v2' ) ) {
	function cb_tab_v2( $atts, $content ){
		...
		$cb_title1 = '<li><a href="#">' . $title . '</a></li>';
		$cb_content1 = '<div class="cb-tab-content">' . do_shortcode( $content ) . '</div>';
...
if ( ! function_exists( 'cb_register_shortcodes' ) ) {
	function cb_register_shortcodes($buttons) {
		array_push($buttons, 'button', 'toggler', 'dropcap', 'alert', 'authorbox', 'highlight', 'tabs', 'column', 'divider', 'videogallery');
		return $buttons;
	}
}
