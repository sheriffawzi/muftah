         ...
         <div id="main" class="cb-full-width clearfix" role="main">
			...
			<article id="post-not-found" class="hentry clearfix">
				...
				<section class="entry-content">			
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/library/images/cb-404.png" data-src-retina="<?php echo get_template_directory_uri();?>/library/images/cb-404@2x.png" class="cloud-404" alt="<?php bloginfo('name');?> 404"/>
